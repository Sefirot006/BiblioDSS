            ...
            if (listFiltradaPorAutor != null)
            {
                ...
                foreach (ObraEN obras in listFiltradaPorAutor)
                {
                    ...
                    if (ejemplaresDisp == 0)
                    {
                        ...
                        Panel2.Controls.Add(new LiteralControl("<br>"));
                        errorReserva.Text = "Haz click en boton Reservar para confirmar";
                        Panel2.Controls.Add(errorReserva);
                    }
                    else
                    {
                        ...
                        Panel2.Controls.Add(lDisponibilidad);
                        Panel2.Controls.Add(new LiteralControl("<br>"));
                        errorReserva.Text = "Acércate a biblioteca para obtener este ejemplar";
                        Panel2.Controls.Add(errorReserva);
                    }
                    Panel2.Controls.Add(new LiteralControl("<br>"));
                    Panel2.Controls.Add(new LiteralControl("<br>"));
