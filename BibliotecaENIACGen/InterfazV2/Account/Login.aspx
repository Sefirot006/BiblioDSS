<%@ Page Title="Iniciar sesión" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Login.aspx.cs" Inherits="InterfazV2.Account.Login" %>
        ...
        <LayoutTemplate>
            ...
            <div class="accountInfo">
                <fieldset class="login">
                    ...
                    <p>
                        <asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="UserName">DNI/NIE de usuario:</asp:Label>
                        <asp:TextBox ID="UserName" runat="server" CssClass="textEntry"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="UserNameRequired" runat="server" ControlToValidate="UserName" 
                             CssClass="failureNotification" ErrorMessage="El nombre de usuario es obligatorio." ToolTip="El DNI/NIE de usuario es obligatorio." 
                ...
                <p class="submitButton">
                    <asp:Button ID="LoginButton" runat="server" CommandName="Login" Text="Iniciar sesión" ValidationGroup="LoginUserValidationGroup" OnClick="boton_registro" />
                </p>
            </div>
        </LayoutTemplate>
    </asp:Login>
